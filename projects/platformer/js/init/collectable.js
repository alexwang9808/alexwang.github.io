(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 200, 170, 25, .8);
        collectable.create(type.grace, 500, 100, 25, 1 );
        collectable.create(type.max, 600, 500, 25, 1);
        collectable.create(type.kennedi, 100, 600, 25, 1);
